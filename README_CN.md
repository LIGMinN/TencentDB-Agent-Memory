...
- 🐞 **发现 Bug 或有疑问？** 欢迎到 [GitHub Issues](https://github.com/<org>/<repo>/issues) 提交，我们承诺 24 小时内首次响应。
- 💡 **有想法想交流？** 欢迎在 [GitHub Discussions](https://github.com/<org>/<repo>/discussions) 发起讨论，新功能提案、架构选型、"这个场景适不适合用 memory" 都可以聊。
- 🛠️ **想贡献代码？** 请先阅读 [CONTRIBUTING.md](./CONTRIBUTING.md)，并从 [`good first issue`](https://github.com/<org>/<repo>/labels/good%20first%20issue) 列表里挑一个上手任务开始。
- 💬 **想加入交流群？** 扫码加入 **Agent Memory 微信社群**，与 Maintainer 和早期开发者直接对话。
